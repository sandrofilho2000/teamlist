...
class CountryDetailView(ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        context = {
            'country': country,
            'main_item': country if request.user.has_perm('countries.change_country') else False,
            'main_item_admin': f"/admin/countries/country/{country.pk}/change/" if request.user.has_perm('countries.change_country') else False,
            'leagues': leagues,
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if request.user.has_perm('countries.change_country'):
                form.save()
